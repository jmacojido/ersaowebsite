							...
							<div class="row">
								...
								<div class="col-md-6">
										...
										<div class="input-group">
											...
											<div class="toggleWrapper">
												<input type="checkbox" id="on_promo" class="dn">
												<label for="on_promo" class="toggle"><span class="toggle__handler"></span></label>
											</div>
										</div><br>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
										...
										<div class="input-group">
											<label>On Promo?</label>
											<div class="toggleWrapper">
												<input type="checkbox" id="add_on_promo" class="dn">
												<label for="add_on_promo" class="toggle"><span class="toggle__handler"></span></label>
											</div>
										</div><br>
								</div>
							</div>
